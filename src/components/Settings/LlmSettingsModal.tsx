      ...
      <div style={{ maxHeight: '60vh', overflowY: 'auto', paddingRight: 10 }}>
        <Form layout="vertical" form={form}>
          <Form.Item
            ...
            name="llm_api_base"
            tooltip="OpenAI 格式接口地址，例如 https://api.openai.com/v1"
            rules={[{ required: true, whitespace: true, message: '请输入 API 请求地址' }]}
          >
            <Input prefix={<ApiOutlined style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="例如 https://api.openai.com/v1" />
          </Form.Item>
          ...
          >
            <Input prefix={<ThunderboltOutlined style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="例如 gpt-4o-mini" />
          </Form.Item>
